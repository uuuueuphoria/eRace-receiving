<%@ Page Title="Security Manager" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="SecurityManagement.aspx.cs" Inherits="ERace_WebApp.Security.SecurityManagement" %>
...
<div class="row">
            ...
            <InsertItemTemplate>
                <tr class="bg-info">
                    <td style="white-space:nowrap;">
                        ...
                        <asp:Button runat="server" CommandName="Cancel" Text="Clear" CssClass="btn btn-default" ID="Button1" />
                    </td>
                    <td>
                        <asp:TextBox Text='<%# BindItem.UserName %>' runat="server" ID="TextBox1" CssClass="form-control" />
                    </td>
                    <td>
                    </td>
                    <td>
                        <asp:TextBox Text='<%# BindItem.Email %>' runat="server" ID="TextBox2" CssClass="form-control" />
                        <asp:TextBox Text='<%# BindItem.PhoneNumber %>' runat="server" ID="TextBox3" CssClass="form-control" />
                    </td>
                </tr>
            </InsertItemTemplate>
            <ItemTemplate>
    ...
    <div class="col-md-3">
        ...
        <asp:ListView ID="RolesListView" runat="server"
            ...
            <ItemTemplate>
                <div>
                    <asp:LinkButton runat="server" CommandName="Delete" ID="LinkButton1"><i class="glyphicon glyphicon-remove"></i></asp:LinkButton>
                    <asp:LinkButton runat="server" CommandName="Edit" ID="LinkButton2"><i class="glyphicon glyphicon-pencil"></i></asp:LinkButton>
                    <%# Item.Name %>
                </div>
            </ItemTemplate>
            <EditItemTemplate>
                <div>
                    <asp:LinkButton runat="server" CommandName="Update" ID="LinkButton3"><i class="glyphicon glyphicon-ok"></i></asp:LinkButton>
                    <asp:LinkButton runat="server" CommandName="Cancel" ID="LinkButton4"><i class="glyphicon glyphicon-arrow-left"></i></asp:LinkButton>
                    <asp:TextBox ID="RoleName" runat="server" Text="<%# BindItem.Name %>"></asp:TextBox>
                </div>
            </EditItemTemplate>
            <InsertItemTemplate>
                <div class="bg-info">
                    <asp:LinkButton runat="server" CommandName="Insert" ID="LinkButton5"><i class="glyphicon glyphicon-plus"></i></asp:LinkButton>
                    <asp:LinkButton runat="server" CommandName="Cancel" ID="LinkButton6"><i class="glyphicon glyphicon-ban-circle"></i></asp:LinkButton>
                    <asp:TextBox ID="TextBox4" runat="server" Text="<%# BindItem.Name %>"></asp:TextBox>
                </div>
            </InsertItemTemplate>
        </asp:ListView>
    </div>
...
<asp:ObjectDataSource ID="UsersDataSource" runat="server"
    ...
    TypeName="ERace_WebApp.Security.SecurityController"
